...
//			// and will throw an exception. Just silently ignore it.
//		}
		...
		//alternatively, delete all of the records from the RecordStore
	...
	protected void DeleteAllRecords() throws RecordStoreFullException, RecordStoreNotFoundException, RecordStoreException
	{
//		//Delete the existing recordstore if there is one.
//		try {
//			RecordStore.deleteRecordStore("JournalEntries");
...
//		}
	...
	{		
		...
		for (RecordEnumeration e = JournalStore.enumerateRecords(null, null, false); e.hasNextElement();)
		{
			...
			int recordID = e.nextRecordId();
			Entry.load(JournalStore.getRecord(recordID));
